 ...
 * @param  {Function} cb      回调函数
 */
module.exports.updateCategory = function (cat_id, newCate, cb) {
	dao.update("CategoryModel", cat_id, { "cat_name": newCate.cate_name, "cat_pid": newCate.cate_pid, "cat_level": newCate.cate_level }, function (err, newCat) {
